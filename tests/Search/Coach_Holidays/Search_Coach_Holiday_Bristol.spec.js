...
test('Test Coach Holiday Search', async ({ page }) => {
    ...
    await test.step('Select Departing From option', async () => {
        await page.waitForSelector('//*[@id="tour-search-results"]/div/section/div[7]/div/div/div/div/div/section/div[2]/div/label[1]/span[1]/span');
    ...
    await test.step('Select Departing Month option', async () => {
        ...
        await getTextAndCompare(page, '//*[@id="ModalDepartureDate"]/div/div/div[1]/h5', 'Departure Date'); // Pop up title verification
