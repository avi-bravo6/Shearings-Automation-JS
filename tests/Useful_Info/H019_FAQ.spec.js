...
test('Test FAQs', async ({ page }) => {
    ...
    await test.step('Verify the page title is "Frequently Asked Questions"', async () => {
    ...
    await test.step('Verify section 1 title "Bagging Your Holiday"', async () => {
    ...
    await test.step('Verify answer for question 1', async () => {
