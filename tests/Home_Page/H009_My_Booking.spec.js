...
test('Test My Booking', async ({ page }) => {
    ...
    await test.step('Verify Agent Login page elements', async () => {
        ...
        // Prefix with xpath= to indicate you're using XPath selectors
        await expect(page.locator('xpath=' + ABTA)).toBeVisible();
        await expect(page.locator('xpath=' + Password)).toBeVisible();
