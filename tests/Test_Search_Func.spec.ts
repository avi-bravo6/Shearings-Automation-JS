...
test('Test Search Functionality', async ({ page }: { page: Page }) => {
    ...
    const searchField: string = '//*[@id="top"]/div[6]/nav/div/ul/li[5]/div/div/div[1]/div[1]/div[1]/div/form/input';
    ...
    const searchResult: string = '//*[@id="top"]/div[6]/nav/div/ul/li[5]/div/div/div[2]/div/div[2]/div/div/ol/li[1]/div/div/a';
    ...
    const pageTitleXpath: string = 'html/body/section[2]/div[2]/div[2]/div[1]/div[1]/h1';
    const expectedTitle: string = "London's Royal Palaces";
    const isTitleCorrect: boolean = await getTextAndCompare(page, pageTitleXpath, expectedTitle);
